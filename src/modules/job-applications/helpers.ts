...
export const normalizeJobApplication = (row: any): JobApplicationDTO => ({
  ...
  jobDescription: normalizeOptionalText(row.jobDescription),
  resumeSnapshotText: normalizeOptionalText(row.resumeSnapshotText),
  resumeLabel: normalizeOptionalText(row.resumeLabel),
  notes: normalizeOptionalText(row.notes),
